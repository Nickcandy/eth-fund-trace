...
func (s *Store) Initialize(ctx context.Context) error {
	for _, name := range []string{AddressesCollection, TransfersCollection, LabelsCollection, SyncJobsCollection, ProfilesCollection, TraceJobsCollection, TransactionAnalysesCollection, PoolMetadataCollection} {
...
func (s *Store) FindSyncCheckpoints(ctx context.Context, chain, address string, startBlock, maxRecordsPerAction int64) (map[string]int64, error) {
	var job SyncJob
